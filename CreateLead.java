...
public class CreateLead 
{
	...
	public static void main(String[] args) 
	{
		...
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Manivel");
		driver.findElement(By.id("createLeadForm_lastName")).sendKeys("Ramar");
		...
		driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("Manivel");
		driver.findElement(By.id("createLeadForm_lastNameLocal")).sendKeys("R");
		driver.findElement(By.id("createLeadForm_personalTitle")).sendKeys("JC");
		driver.findElement(By.id("createLeadForm_birthDate")).sendKeys("01/01/1995");
		...
		driver.findElement(By.id("createLeadForm_primaryPhoneAskForName")).sendKeys("Manivel");
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("maniveljc3@gmail.com");
		driver.findElement(By.id("createLeadForm_primaryWebUrl")).sendKeys("https//www.twitter.com/manivel.jkbmv/");
		
		//Primary Address
		driver.findElement(By.id("createLeadForm_generalToName")).sendKeys("Manivel");
		driver.findElement(By.id("createLeadForm_generalAttnName")).sendKeys("JC");
		driver.findElement(By.id("createLeadForm_generalAddress1")).sendKeys("Mettupatti");
		driver.findElement(By.id("createLeadForm_generalAddress2")).sendKeys("Musiri");
		driver.findElement(By.id("createLeadForm_generalCity")).sendKeys("Tiruchirappalli");
		...
		driver.findElement(By.id("createLeadForm_generalPostalCode")).sendKeys("621211");
		driver.findElement(By.id("createLeadForm_generalPostalCodeExt")).sendKeys("62");
